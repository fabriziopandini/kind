...
// and worker nodes
func NewConfig(controlPlanes, workers int32, kubeDNS bool, externalEtcdIP string, externalLoadBalancer bool) *config.Config {
	...
	// if requrester or more than one control-plane node(s), add an external load balancer

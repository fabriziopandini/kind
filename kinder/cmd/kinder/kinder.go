...
import (
	...
	kbuild "sigs.k8s.io/kind/kinder/cmd/kinder/build"
	kcp "sigs.k8s.io/kind/kinder/cmd/kinder/cp"
	kcreate "sigs.k8s.io/kind/kinder/cmd/kinder/create"
	kdo "sigs.k8s.io/kind/kinder/cmd/kinder/do"
	kexec "sigs.k8s.io/kind/kinder/cmd/kinder/exec"
	kversion "sigs.k8s.io/kind/kinder/cmd/kinder/version"
)
